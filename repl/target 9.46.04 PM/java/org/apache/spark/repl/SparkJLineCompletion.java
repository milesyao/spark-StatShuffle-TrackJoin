...
public  class SparkJLineCompletion implements scala.tools.nsc.interpreter.Completion, scala.tools.nsc.interpreter.CompletionOutput, org.apache.spark.Logging {
  ...
  private  scala.reflect.internal.Symbols.Symbol getSymbol (java.lang.String name, boolean isModule) { throw new RuntimeException(); }
  private  scala.reflect.internal.Types.Type getType (java.lang.String name, boolean isModule) { throw new RuntimeException(); }
  private  scala.reflect.internal.Types.Type typeOf (java.lang.String name) { throw new RuntimeException(); }
  private  scala.reflect.internal.Types.Type moduleOf (java.lang.String name) { throw new RuntimeException(); }
  ...
  private  scala.collection.immutable.List<scala.tools.nsc.interpreter.CompletionAware> topLevelBase () { throw new RuntimeException(); }
  private  scala.collection.immutable.List<scala.tools.nsc.interpreter.CompletionAware> topLevel () { throw new RuntimeException(); }
  private  int topLevelThreshold () { throw new RuntimeException(); }
  private  scala.collection.immutable.List<java.lang.String> topLevelFor (scala.tools.nsc.interpreter.Parsed parsed) { throw new RuntimeException(); }
  private  scala.tools.nsc.interpreter.CompletionAware lastResult () { throw new RuntimeException(); }
  private  scala.collection.immutable.List<java.lang.String> lastResultFor (scala.tools.nsc.interpreter.Parsed parsed) { throw new RuntimeException(); }
  private  scala.collection.immutable.List<java.lang.String> completions (java.lang.String buf) { throw new RuntimeException(); }
  /**
