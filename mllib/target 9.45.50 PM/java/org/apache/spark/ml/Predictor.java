...
public abstract class Predictor<FeaturesType extends java.lang.Object, Learner extends org.apache.spark.ml.Predictor<FeaturesType, Learner, M>, M extends org.apache.spark.ml.PredictionModel<FeaturesType, M>> extends org.apache.spark.ml.Estimator<M> implements org.apache.spark.ml.PredictorParams {
  ...
  // TypeTree().setOriginal(TypeBoundsTree(TypeTree().setOriginal(Select(Select(Ident(_root_), scala), scala.Nothing)), TypeTree().setOriginal(AppliedTypeTree(Ident(org.apache.spark.ml.Predictor), List(TypeTree().setOriginal(Ident(newTypeName("FeaturesType"))), TypeTree().setOriginal(Ident(newTypeName("Learner"))), TypeTree().setOriginal(Ident(newTypeName("M"))))))))
  // TypeTree().setOriginal(TypeBoundsTree(TypeTree().setOriginal(Select(Select(Ident(_root_), scala), scala.Nothing)), TypeTree().setOriginal(AppliedTypeTree(Ident(org.apache.spark.ml.PredictionModel), List(TypeTree().setOriginal(Ident(newTypeName("FeaturesType"))), TypeTree().setOriginal(Ident(newTypeName("M"))))))))
  ...
  public  M fit (org.apache.spark.sql.DataFrame dataset) { throw new RuntimeException(); }
   ...
   * @return  Fitted model
   */
  protected abstract  M train (org.apache.spark.sql.DataFrame dataset) ;
  /**
   ...
   * @return (undocumented)
   */
  protected  org.apache.spark.rdd.RDD<org.apache.spark.mllib.regression.LabeledPoint> extractLabeledPoints (org.apache.spark.sql.DataFrame dataset) { throw new RuntimeException(); }
}
