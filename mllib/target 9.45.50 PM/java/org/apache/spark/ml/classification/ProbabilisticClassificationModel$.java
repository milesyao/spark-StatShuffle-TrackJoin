...
// no position
  class ProbabilisticClassificationModel$ implements scala.Serializable {
  /**
   ...
   */
  public  void normalizeToProbabilitiesInPlace (org.apache.spark.mllib.linalg.DenseVector v) { throw new RuntimeException(); }
}
