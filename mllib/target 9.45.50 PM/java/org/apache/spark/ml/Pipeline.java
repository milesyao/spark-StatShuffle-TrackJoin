...
public  class Pipeline extends org.apache.spark.ml.Estimator<org.apache.spark.ml.PipelineModel> implements org.apache.spark.ml.util.MLWritable {
  // no position
  /** Methods for {@link MLReader} and {@link MLWriter} shared between {@link Pipeline} and {@link PipelineModel} */
   ...
   */
  public  org.apache.spark.ml.PipelineModel fit (org.apache.spark.sql.DataFrame dataset) { throw new RuntimeException(); }
