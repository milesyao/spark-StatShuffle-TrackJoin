 ...
 */
public abstract class LDAModel extends org.apache.spark.ml.Model<org.apache.spark.ml.clustering.LDAModel> implements org.apache.spark.ml.clustering.LDAParams, org.apache.spark.Logging, org.apache.spark.ml.util.MLWritable {
  ...
  // not preceding
     LDAModel (java.lang.String uid, int vocabSize, org.apache.spark.sql.SQLContext sqlContext) { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.mllib.linalg.Vector estimatedDocConcentration () { throw new RuntimeException(); }
  /**
   ...
   */
  public  double logLikelihood (org.apache.spark.sql.DataFrame dataset) { throw new RuntimeException(); }
  /**
   ...
   */
  public  double logPerplexity (org.apache.spark.sql.DataFrame dataset) { throw new RuntimeException(); }
  /**
   ...
   */
  public  org.apache.spark.sql.DataFrame describeTopics (int maxTermsPerTopic) { throw new RuntimeException(); }
  public  org.apache.spark.sql.DataFrame describeTopics () { throw new RuntimeException(); }
}
