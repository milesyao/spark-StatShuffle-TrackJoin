 ...
 */
   ...
   */
  static public  org.apache.spark.rdd.RDD<org.apache.spark.ml.tree.impl.TreePoint> convertToTreeRDD (org.apache.spark.rdd.RDD<org.apache.spark.mllib.regression.LabeledPoint> input, org.apache.spark.ml.tree.Split[][] splits, org.apache.spark.mllib.tree.impl.DecisionTreeMetadata metadata) { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static private  org.apache.spark.ml.tree.impl.TreePoint labeledPointToTreePoint (org.apache.spark.mllib.regression.LabeledPoint labeledPoint, double[][] thresholds, int[] featureArity) { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static private  int findBin (int featureIndex, org.apache.spark.mllib.regression.LabeledPoint labeledPoint, int featureArity, double[] thresholds) { throw new RuntimeException(); }
