...
public  class PolynomialExpansion$ implements org.apache.spark.ml.util.DefaultParamsReadable<org.apache.spark.ml.feature.PolynomialExpansion>, scala.Serializable {
  ...
  private  int choose (int n, int k) { throw new RuntimeException(); }
  ...
  private  org.apache.spark.mllib.linalg.DenseVector expand (org.apache.spark.mllib.linalg.DenseVector dv, int degree) { throw new RuntimeException(); }
  private  org.apache.spark.mllib.linalg.SparseVector expand (org.apache.spark.mllib.linalg.SparseVector sv, int degree) { throw new RuntimeException(); }
    org.apache.spark.mllib.linalg.Vector expand (org.apache.spark.mllib.linalg.Vector v, int degree) { throw new RuntimeException(); }
