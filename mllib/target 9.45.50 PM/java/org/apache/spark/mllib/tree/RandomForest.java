...
public  class RandomForest implements scala.Serializable, org.apache.spark.Logging {
   ...
   * @return (undocumented)
   */
  static   long aggregateSizeForNode (org.apache.spark.mllib.tree.impl.DecisionTreeMetadata metadata, scala.Option<int[]> featureSubset) { throw new RuntimeException(); }
