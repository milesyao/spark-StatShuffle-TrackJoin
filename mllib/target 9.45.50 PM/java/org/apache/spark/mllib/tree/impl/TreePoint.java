 ...
 */
   ...
   * @return (undocumented)
   */
  static private  org.apache.spark.mllib.tree.impl.TreePoint labeledPointToTreePoint (org.apache.spark.mllib.regression.LabeledPoint labeledPoint, org.apache.spark.mllib.tree.model.Bin[][] bins, int[] featureArity) { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static private  int findBin (int featureIndex, org.apache.spark.mllib.regression.LabeledPoint labeledPoint, int featureArity, org.apache.spark.mllib.tree.model.Bin[][] bins) { throw new RuntimeException(); }
