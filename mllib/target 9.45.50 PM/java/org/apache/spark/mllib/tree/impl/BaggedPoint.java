 ...
 */
   ...
   */
  static public <Datum extends java.lang.Object> org.apache.spark.rdd.RDD<org.apache.spark.mllib.tree.impl.BaggedPoint<Datum>> convertToBaggedRDD (org.apache.spark.rdd.RDD<Datum> input, double subsamplingRate, int numSubsamples, boolean withReplacement, long seed) { throw new RuntimeException(); }
  static private <Datum extends java.lang.Object> org.apache.spark.rdd.RDD<org.apache.spark.mllib.tree.impl.BaggedPoint<Datum>> convertToBaggedRDDSamplingWithoutReplacement (org.apache.spark.rdd.RDD<Datum> input, double subsamplingRate, int numSubsamples, long seed) { throw new RuntimeException(); }
  static private <Datum extends java.lang.Object> org.apache.spark.rdd.RDD<org.apache.spark.mllib.tree.impl.BaggedPoint<Datum>> convertToBaggedRDDSamplingWithReplacement (org.apache.spark.rdd.RDD<Datum> input, double subsample, int numSubsamples, long seed) { throw new RuntimeException(); }
