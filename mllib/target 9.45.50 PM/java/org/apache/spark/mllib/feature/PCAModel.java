...
public  class PCAModel implements org.apache.spark.mllib.feature.VectorTransformer {
  ...
  // not preceding
     PCAModel (int k, org.apache.spark.mllib.linalg.DenseMatrix pc) { throw new RuntimeException(); }
  /**
   * Transform a vector by computed Principal Components.
   * <p>
   * @param vector vector to be transformed.
   *               Vector must be the same length as the source vectors given to {@link PCA.fit()}.
